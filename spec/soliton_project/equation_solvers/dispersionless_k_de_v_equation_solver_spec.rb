...
describe SolitonProject::DispersionlessKDeVEquationSolver do
  ...
  before(:each) do
    ...
    @t_interval = 0.01
    @dispersionless_k_de_v_equation_solver = 
      SolitonProject::DispersionlessKDeVEquationSolver.new(
        @initial_condition,
  ...
  it "should inherit from the EquationSolver class" do
    @dispersionless_k_de_v_equation_solver.should be_a_kind_of(
      SolitonProject::EquationSolver
    )
  end
  
  it "should overwrite the differential_function method" do
    @dispersionless_k_de_v_equation_solver.public_methods(false).should 
      include(
  ...
  describe "#differential_function" do
    ...
    it "should return an object that responds to call" do
      @dispersionless_k_de_v_equation_solver.differential_function.should 
        respond_to(:call)
    end
